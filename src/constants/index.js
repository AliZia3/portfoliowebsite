...
export const pythonProjects = [
	{
		...
		description: 'A Python program that utilizes historical match data and statistical analysis to predict the outcome of Premier League matches.',
		image: '',
		source_code_link: '',
	},
	{
		name: "Image Classifier",
		description: 'A Python project that employs machine learning techniques to categorize and classify images based on their visual features.',
		image: '',
		source_code_link: '',
	},
	{
		name: "Drive Test Availablity Finder",
		description: 'A helpful tool that automates the process of checking for available dates for driving tests, allowing users to quickly find and secure a suitable appointment.',
		image: '',
		source_code_link: '',
	},
	{
...
export const webProjects = [
	{
		name: "MERNstagram",
		description: 'A full-stack web application built with the MERN (MongoDB, Express.js, React.js, Node.js) stack, designed to resemble a social media platform for sharing photos and connecting with other users.',
		image: '',
		source_code_link: '',
	},
	{
		name: "EasyChat",
		description: 'A user-friendly chat application that allows real-time communication between users, providing features such as private messaging, group chats, and multimedia sharing.',
		image: '',
		source_code_link: '',
	},
	{
...
export const javaProjects = [
	{
		...
		description: 'A tool designed to help users streamline their job application process by providing features for tracking job listings, storing application details, and managing interview schedules and follow-ups.',
		image: '',
		source_code_link: '',
	},
	{
		name: "Island Generator",
		description: 'An application that generates unique and customizable islands in the form of an svg file from user-defined parameters.',
		image: '',
		source_code_link: '',
	},
	{
		name: "Piraten Kapern Simulator",
		description: 'A simulation game inspired by the board game Piraten Kapern',
		image: '',
		source_code_link: '',
	},
]
