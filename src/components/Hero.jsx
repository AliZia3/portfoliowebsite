...
const Hero = () => {
	...
	return (
		...
		<section id='Hero' className="relative w-full h-screen mx-auto">
			...
			<motion.div variants={fadeIn('down', '', 0.5, 1)} initial="hidden" whileInView="show" className="absolute xs:bottom-10 bottom-14 w-full flex justify-center items-center">
				<a href="#about">
